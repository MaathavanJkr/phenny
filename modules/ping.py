...
hello.rule = r'(?:$nickname[,:]* )?(?i)(hi|vanakkam|hello|hey|what\'s kickin[\'g]*|how you been|what\'s (.*)good(.*)|what\'s up|sup|(?:top o[\'f]* the )?mornin[\'g]*|what\'s hangin[\'g]*|yo|in the hood|in da hood|kaixo|zer moduz|с[әа]л[еао]м|s[ae]l[ao]m|wb|mitä kuuluu|როგორა ხარ|ինչպե՞ս ես|сайн байна уу|कैसे हो|como vai|привет|salut|n(?:в)орчӏами|nasılsın(?:ız)?)(?:[,]* $nickname)?[ \t!\.\?]*$'
